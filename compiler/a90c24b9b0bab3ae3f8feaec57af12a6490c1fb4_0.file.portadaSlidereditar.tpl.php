<?php /* Smarty version 3.1.27, created on 2021-08-03 10:50:41
         compiled from "C:\xampp\htdocs\cake\styles\templates\panel\portadaSlidereditar.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:18882957306109036155bd08_34744635%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a90c24b9b0bab3ae3f8feaec57af12a6490c1fb4' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cake\\styles\\templates\\panel\\portadaSlidereditar.tpl',
      1 => 1624344512,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18882957306109036155bd08_34744635',
  'variables' => 
  array (
    'datos' => 0,
  ),
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_610903615a1a28_06559847',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_610903615a1a28_06559847')) {
function content_610903615a1a28_06559847 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '18882957306109036155bd08_34744635';
?>
<!DOCTYPE html>
<html lang="en">
  <head>
...
" />
                                <?php }?>
                                <span id="imagen_span"><?php if ($_smarty_tpl->tpl_vars['datos']->value['imagen'] == '') {?>Añadir la imagen (1900 x 600 px)<?php }?></span>
                              </div>                                        
                              <!-- fin imagen -->  
                              ...
                              <div class="input-group">
                                ...
                                <textarea class="form-control" name="titulo"><?php echo $_smarty_tpl->tpl_vars['datos']->value['titulo'];?>
</textarea>
                              </div>
                              ...
                              <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-list-alt"></i></span>
                                <textarea class="form-control" name="texto"><?php echo $_smarty_tpl->tpl_vars['datos']->value['texto'];?>
</textarea>
                              </div>
                              <!-- fin texto linea simple -->
                              ...
                              <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-list-alt"></i></span>
                                <input type="text" class="form-control" id="boton" name="boton" value="<?php echo $_smarty_tpl->tpl_vars['datos']->value['boton'];?>
">
                              </div>
                              <!-- fin texto linea simple -->
                              ...
                              <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-list-alt"></i></span>
                                <input type="text" class="form-control" id="enlace" name="enlace" value="<?php echo $_smarty_tpl->tpl_vars['datos']->value['enlace'];?>
">
                              </div>
                              <!-- fin texto linea simple -->
