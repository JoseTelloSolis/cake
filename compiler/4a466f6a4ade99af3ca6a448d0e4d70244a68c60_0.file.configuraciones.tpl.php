<?php /* Smarty version 3.1.27, created on 2021-08-03 07:58:49
         compiled from "C:\xampp\htdocs\cake\styles\templates\panel\configuraciones.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:15546320236108db19cb6343_56219542%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4a466f6a4ade99af3ca6a448d0e4d70244a68c60' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cake\\styles\\templates\\panel\\configuraciones.tpl',
      1 => 1623269055,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15546320236108db19cb6343_56219542',
  'variables' => 
  array (
    'datos' => 0,
  ),
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_6108db19d6c455_40210845',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_6108db19d6c455_40210845')) {
function content_6108db19d6c455_40210845 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '15546320236108db19cb6343_56219542';
?>
<!DOCTYPE html>
<html lang="en">
  <head>
                              ...
                              <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="general">
                                  ...
                                  <div class="div-imagen" style="min-height:100px;background-image: none;" data-toggle="tooltip" data-placement="top" title="Clic en la imagen para reemplazarla">
                                    <?php if ($_smarty_tpl->tpl_vars['datos']->value['logo'] == '') {?>
                                      <img id="imagen_preview" class="img-responsive preview-image" style="max-width: 450px;" />
                                      <span id="imagen_span"><?php if ($_smarty_tpl->tpl_vars['datos']->value['logo'] == '') {?>Añadir la imagen (300 x 150 px)<?php }?></span>
                                    <?php } else { ?>
                                      <img id="imagen_preview" class="img-responsive preview-image" style="max-width: 450px;" src="<?php echo $_smarty_tpl->tpl_vars['datos']->value['logo'];?>
" />
                                  ...
                                  <div class="div-imagen" style="min-height:100px;background-image: none;" data-toggle="tooltip" data-placement="top" title="Clic en la imagen para reemplazarla">
                                    <?php if ($_smarty_tpl->tpl_vars['datos']->value['logo_mini'] == '') {?>
                                      <img id="imagen2_preview" class="img-responsive preview-image" style="max-width: 450px;" />
                                      <span id="imagen2_span"><?php if ($_smarty_tpl->tpl_vars['datos']->value['logo_mini'] == '') {?>Añadir la imagen (500 x 100 px)<?php }?></span>
                                    <?php } else { ?>
                                      <img id="imagen2_preview" class="img-responsive preview-image" style="max-width: 450px;" src="<?php echo $_smarty_tpl->tpl_vars['datos']->value['logo_mini'];?>
" />
                                  ...
                                  <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="email" name="email" value="<?php echo $_smarty_tpl->tpl_vars['datos']->value['email'];?>
">
                                  </div>
                                  ...
                                  <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-list-alt"></i></span>
                                    <input type="text" class="form-control" id="telefono" name="telefono" value="<?php echo $_smarty_tpl->tpl_vars['datos']->value['telefono'];?>
">
                                  </div>
                                  <!-- fin texto linea simple -->
                                  ...
                                  <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-list-alt"></i></span>
                                    <textarea class="form-control" id="direccion" name="direccion"><?php echo $_smarty_tpl->tpl_vars['datos']->value['direccion'];?>
</textarea>
                                  </div>
                                  <!-- fin texto linea simple --> 
                                  ...
                                  <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-list-alt"></i></span>
                                    <textarea class="form-control" id="horario" name="horario"><?php echo $_smarty_tpl->tpl_vars['datos']->value['horario'];?>
</textarea>
                                  </div>
                                  <!-- fin texto linea simple --> 
...
?>
  ...
  <?php echo '<script'; ?>
 src="styles/librerias/switchery/dist/switchery.min.js"><?php echo '</script'; ?>
>
