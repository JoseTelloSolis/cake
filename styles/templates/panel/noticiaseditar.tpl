                ...
                <div class="row">
                  <div class="col-sm-12">
                    ...
                    <span class="help-block">
                      <a href="panelnoticias.html"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span> Volver al listado de Noticias</a>
                    </span>
                            ...
                            <div class="col-md-12"> 
                              ...
                              <div class="input-group">
                                ...
                                <select name="id_categoria" class="form-control">
                                  ...
                                  {section name=i loop=$datosCategorias}
                                    {if $datosCategorias[i].id EQ $datos.id_categoria}
                                      <option value="{$datosCategorias[i].id}" selected>{$datosCategorias[i].nombre}</option>
                                    {else}
                                      <option value="{$datosCategorias[i].id}">{$datosCategorias[i].nombre}</option>
                                    {/if}
                                  {/section}
                                </select>
                              </div>
                              ...
                              <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-list-alt"></i></span>
                                <input type="hidden" id="fecha-actual" value="{$datos.fecha}">
                              ...
                              <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-list-alt"></i></span>
                                <input type="text" class="form-control" id="autor" name="autor" value="{$datos.autor}">
                              </div>
                              <!-- fin texto linea simple --> 
                              ...
                              <!-- imagen -->
                              <span class="help-block">
                                Imagen - tamaño recomendado 800 x 450 px
                              </span>
                              ...
                              <div class="div-imagen" style="min-height:200px;" data-toggle="tooltip" data-placement="top" title="Clic en la imagen para reemplazarla">
                                ...
                                {/if}
                                <span id="imagen_span">{if $datos.imagen eq ''}Añadir la imagen (800 x 450 px){/if}</span>
                              </div>                                        
                              <!-- fin imagen -->  

                              <!-- texto linea simple -->
                              <span class="help-block">
                                Descripcion de la imagen - opcional
                              </span>
                              <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-list-alt"></i></span>
                                <input type="text" class="form-control" id="imagen_descripcion" name="imagen_descripcion" value="{$datos.imagen_descripcion}">
                              </div>
                              <!-- fin texto linea simple --> 
                              ...
                              <div class="input-group ckeditor-texto">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-list-alt"></i></span>
                                <textarea id="texto" name="texto" class="form-control">{$datos.texto}</textarea>
                              </div>
        ...
        $.ajax({
          ...
          success: function(datos) {
            ...
            if(parseInt(datos) == 1){
              ...
              $('#mensaje').html('Noticia actualizada.');
            }
            else if(datos == 3) {
