                  ...
                  <div class="col-sm-12">
                    ...
                    <div class="panel panel-primary fondo-gris">
                      ...
                      <div class="panel-heading">
                        <div class="panel-title">Crear Testimonio</div>
                      </div>  
                          ...
                          <div class="row">
                            ...
                            <!-- imagen -->
                              ...
                              <div class="div-imagen" style="min-height:200px;" data-toggle="tooltip" data-placement="top" title="Clic en la imagen para reemplazarla">
                                ...
                                <span id="imagen_span">Añadir la imagen (200 x 200 px)</span>
                              </div>                                        
                              <!-- fin imagen -->                                
  ...
  <script>    
    ...
    $(document).ready( function() {
      ...
      $("#guardar").click(function(){
        ...
        $.ajax({
            url: "paneltestimonioscrear.html",
            type: "POST",
            cache: false,
            contentType: false,
            processData: false,
            ...
            success: function(datos) {
              ...
              if(datos == 1){
                ...
                $('#mensaje').html('Testimonio creado.');

                setTimeout(function(){ 
                    window.location.href = 'paneltestimonios.html';
                }, 1000);
              }
              else{
