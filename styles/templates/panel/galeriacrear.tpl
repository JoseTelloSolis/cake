                        ...
                        <form id="formulario" class="form form-horizontal periodico" role="form" enctype="multipart/form-data">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-12">                                
                              ...
                              <!-- imagen -->
                              <span class="help-block">
                                Imagen principal - tamaño recomendado 800 x 600 px
                              </span>
                              ...
                              <div class="div-imagen" style="min-height:200px;" data-toggle="tooltip" data-placement="top" title="Clic en la imagen para reemplazarla">
                                ...
                                <span id="imagen_span">Añadir la imagen (800 x 600 px)</span>
                              </div>                                        
                              <!-- fin imagen -->                               
        ...
        $.ajax({
            ...
            success: function(datos) {
              ...
              if(datos == 1){
                ...
                $('#mensaje').html('Imagen creada.');

                setTimeout(function(){ 
                    window.location.href = 'panelgaleria.html';
                }, 1000);
              }
              else{
