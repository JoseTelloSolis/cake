...
<html lang="en">
                  ...
                  <div class="col-sm-12">
                    ...
                    <div class="panel panel-primary">
                      ...
                      <div class="panel-heading">
                        <div class="panel-title">Administrar Noticias</div>
                      </div>  
                        
                      <div class="panel-body">
                        <div class="table-responsive">
                            
                          <a href="panelnoticiascrear.html" class="btn btn-success btn-md"><i class="fa fa-file"></i> Añadir Nuevo</a> <span id="mensaje"></span>
  ...
  <script>    
    ...
    function cargar(){
      ...
      var parametros = {
        "editar" : "panelnoticiaseditar.html"
      };
    ...
    $(document).ready( function() {
      ...
      $('#listado').on('click', '.eliminar', function (){
        ...
        var confirmacion = confirm("Esta por eliminar una noticia. ¿Aún desea hacerlo?");
          ...
          $.ajax({
            ...
            success:  function(datos) {
              if(parseInt(datos) == 1){
                ...
                $('#mensaje').html('Noticia eliminada.');
