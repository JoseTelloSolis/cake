                  ...
                  <div class="col-sm-12">
                    ...
                    <div class="panel panel-primary fondo-gris">
                      ...
                      <div class="panel-heading">
                        <div class="panel-title">Crear Noticia</div>
                      </div>  
                        ...
                        <form id="formulario" class="form form-horizontal periodico" role="form" enctype="multipart/form-data">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-12">  
                              ...
                              <!-- imagen -->
                              <span class="help-block">
                                Imagen principal - tamaño recomendado 800 x 450 px
                              </span>
                              ...
                              <div class="div-imagen" style="min-height:200px;" data-toggle="tooltip" data-placement="top" title="Clic en la imagen para reemplazarla">
                                ...
                                <span id="imagen_span">Añadir la imagen (800 x 450 px)</span>
                              </div>                                        
                              <!-- fin imagen --> 
                              ...
                              <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-list-alt"></i></span>
                                <input type="text" class="form-control" id="imagen_descripcion" name="imagen_descripcion">
                              </div>
                              <!-- fin texto linea simple --> 
