                ...
                <div class="row">
                  <div class="col-sm-12">
                    ...
                    <span class="help-block">
                      <a href="panelcategorias.html"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span> Volver al listado de Categorias</a>
                    </span>
                        ...
                        <form id="formulario" class="form form-horizontal periodico" role="form" enctype="multipart/form-data">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-12">  
                              ...
                              <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-list-alt"></i></span>
                                <input type="text" class="form-control jscolor" id="color" name="color" placeholder="Ingrese el color" value="33f1b7">
                              </div>
                              <!-- fin texto linea simple -->
                              ...
                              <!-- imagen -->
                              <span class="help-block">
                                Imagen de fondo - tamaño recomendado 2000 x 300 px
                              </span>
                              ...
                              <div class="div-imagen" style="min-height:200px;" data-toggle="tooltip" data-placement="top" title="Clic en la imagen para reemplazarla">
                                ...
                                <span id="imagen_span">Añadir la imagen (2000 x 300 px)</span>
                              </div>                                        
                              <!-- fin imagen --> 
        ...
        $.ajax({
            ...
            success: function(datos) {
              ...
              if(datos == 1){
                ...
                $('#mensaje').html('Categoria creada.');

                setTimeout(function(){ 
                    window.location.href = 'panelcategorias.html';
                }, 1000);
              }
              else if(datos == 3) {
