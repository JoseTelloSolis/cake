                          ...
                          <div class="row">
                            ...
                            <!-- imagen -->
                              ...
                              <div class="div-imagen" style="min-height:200px;" data-toggle="tooltip" data-placement="top" title="Clic en la imagen para reemplazarla">
                                ...
                                <span id="imagen_span">Añadir la imagen (250 x 220 px)</span>
                              </div>                                        
                              <!-- fin imagen -->                                
        ...
        $.ajax({
            ...
            success: function(datos) {
              ...
              if(datos == 1){
                ...
                $('#mensaje').html('Empleado creado.');

                setTimeout(function(){ 
                    window.location.href = 'panelempleados.html';
                }, 1000);
              }
              else{
