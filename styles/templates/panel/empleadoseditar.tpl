                          ...
                          <div class="row">
                            ...
                            <div class="col-md-12"> 
                              ...
                              <div class="div-imagen" style="min-height:200px;" data-toggle="tooltip" data-placement="top" title="Clic en la imagen para reemplazarla">
                                ...
                                {/if}
                                <span id="imagen_span">{if $datos.imagen eq ''}Añadir la imagen (250 x 220 px){/if}</span>
                              </div>                                        
                              <!-- fin imagen -->  
                              ...
                              <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-list-alt"></i></span>
                                <input type="text" class="form-control" id="linkedin" name="linkedin" value="{$datos.linkedin}">
                              </div>
                              <!-- fin texto linea simple -->
