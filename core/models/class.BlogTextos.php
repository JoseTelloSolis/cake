...
class BlogTextos{
	...
	public function getDatos(){
		...
		try{
			...
			$sql = $db->query("SELECT * FROM blog_textos WHERE id=1;");
	...
	public function editar(){
	    ...
	    $sql = $db->query("UPDATE blog_textos SET
			titulo='$titulo'
			WHERE id=1;");
        ...
        $sql_imagen = $db->query("UPDATE blog_textos SET imagen='$nombreArchivoFinal' WHERE id=1;");
	    }
	    //fin subir fotos
